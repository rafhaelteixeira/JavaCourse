...
public class Student {
    ...
    //when we have a method inside an object, this method has access to the object's data
    public void print() {
        System.out.println("-------------------------");
        ...
        //the this keyword is not mandatory if we do not have another loca variable as parameter
